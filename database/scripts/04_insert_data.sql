...
DELETE FROM [FEEDBACK]; DELETE FROM [OWN]; DELETE FROM [IN]; DELETE FROM [RELATE]; DELETE FROM [REQUIRE]; DELETE FROM [NOTIFY]; DELETE FROM [APPLY]; DELETE FROM [FOLLOW]; DELETE FROM [SOCIAL_LINK]; DELETE FROM [SENDMSG]; DELETE FROM [MESSAGE]; DELETE FROM [JOB_HISTORY]; DELETE FROM [JOB]; DELETE FROM [SKILL]; DELETE FROM [JOB_CATEGORY]; DELETE FROM [COMPANY]; DELETE FROM [PERSON]; DELETE FROM [USER]; DBCC CHECKIDENT ('[USER]', RESEED, 1); DBCC CHECKIDENT ('[JOB]', RESEED, 1);
